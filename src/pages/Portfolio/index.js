                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 bg-azulEscuro sm:ml-48">
                        ...
                        <div>
                            ...
                            <div class="w-full flex flex-col gap-1 my-2">
                                <h2 class="text-lg font-bold">
                                    Projeto Landing Page DevHouse</h2>
                                <div>
                    ...
                    >
                        <div>
                            ...
                            <div class="w-full flex flex-col gap-1 my-2">
                                <h2 class="text-lg font-bold">
                                    ...
                                    Projeto Pontual: Oficina Mecânica Mack Car</h2>
                                <div>
                        ...
                        <div class="mt-auto">
                            ...
                            <span class="font-medium text-sm">CSS - </span>
                            <span class="font-medium text-sm">React - </span>
                            <span class="font-medium text-sm">Styled Component - </span>
                            <span class="font-medium text-sm">Javascript -</span>
                    ...
                    <a
                        href="https://cardapio-beta-five.vercel.app/"
                        class="bg-zinc-200 p-3 rounded-lg min-h-[400px] relative flex flex-col hover:shadow-xl duration-300"
                    >
                        <div>
                            ...
                            <div class="w-full flex flex-col gap-1 my-2">
                                <h2 class="text-lg font-bold">
                                    ...
                                    Projeto para venda - Cardápio</h2>
                                <div>
                                    <p class="text-gray-600 text-sm ">Este projeto foi desenvolvido para a venda de um cardápio online, utilizando tecnologias como HTML, TailwindCSS e JavaScript. O objetivo foi criar uma interface amigável e funcional que facilita a experiência de compra dos usuários, sendo totalmente responsiva para dispositivos móveis e desktops.<br/>

                                      <b>  Funcionalidades do Projeto:</b><br/>
                                       <b> Menu de Itens:</b> Os clientes podem visualizar e selecionar itens do cardápio.<br/>
                                       <b> Carrinho de Compras:</b> Os itens adicionados ao carrinho podem ser visualizados, com a opção de remover itens conforme necessário.<br/>
                                       <b> Finalização do Pedido:</b> Ao concluir a compra, o pedido é enviado diretamente para o WhatsApp do cliente, incluindo o endereço, os itens solicitados e o total a pagar.<br/>
                                       <b> Toast de Notificação:</b> Utilize um sistema de notificações toast para informar os clientes quando o local está fechado.<br/>
                                       <b> Indicação de Horário:</b> Um input exibe os dias da semana e horários de funcionamento. Quando o estabelecimento está aberto, o input fica verde, e quando fechado, fica vermelho.<br/>
                                        Este projeto destaca-se pela sua usabilidade e eficiência, proporcionando uma experiência de usuário intuitiva e direta. A integração com o WhatsApp garante uma comunicação rápida e eficaz entre o cliente e o estabelecimento. </p>
